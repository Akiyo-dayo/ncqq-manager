...
class AsyncLoginChecker:
    ...
    def _normalize_uin(value) -> str:
        ...
        NapCat WebUI payloads may include a short internal `uid` (e.g. 77/9264).
        That is not a QQ number and must never be used for avatars/search/API.
        QQ UINs are treated as at least 5 digits here.
        """
